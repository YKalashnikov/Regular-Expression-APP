  ...
  languages: {
    en: {
      ...
      footer: {
        links: [
          {label: 'News', url: '#'},
          {label: 'Issues', url: 'https://github.com/ /rgxp/issues'},
          {label: 'Contacts', url: 'https://github.com/ /rgxp#contacts'},
          {label: 'GitHub', url: 'https://github.com/ /rgxp'},
        ]
      },
    },
    ru: {
      ...
      footer: {
        links: [
          {label: 'Новости', url: '#'},
          {label: 'Вопросы', url: 'https://github.com/ /rgxp/issues'},
          {label: 'Контакты', url: 'https://github.com/ /rgxp#contacts'},
          {label: 'GitHub', url: 'https://github.com/ /rgxp'},
        ]
      }
    }
